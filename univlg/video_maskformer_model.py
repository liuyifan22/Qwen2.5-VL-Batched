...
from scannet_tools.pointcloud_image_exploration import MultiTurnExplorationFramework
...
class UniVLG(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if 1:
            ...
            # multi_scale_xyz = batched_inputs[0]["multi_scale_xyz"] # feature scales. 35*46
            # # but we want pixel scales
            # import pdb; pdb.set_trace()
            ...
            """We can directly check: whether the corresponding target exists in that image. Maybe there is some function for this"""
